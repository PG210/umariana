                ...
                <div class="row flex-grow">
                    <div class="col-4 mx-auto card_wh1">
                        <div class="auth-form-light p-5 text-center align-items-center card_wh">
                            <form class=" needs-validation" id="frm_log" novalidate method="post" action='./php/login.php'>
                                <div class="brand-logo">
                                    <img src="./assets/images/lg.png" id="img_lg">
                                </div>
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-lg" pattern=".+@umariana\.edu.co" name="email" id="correo" required placeholder="correo@umariana.edu.co">
                                    <div class="invalid-feedback">
                                        Ingrese su correo electrónico institucional.
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control form-control-lg" name="passw" id="contra" required placeholder="contraseña">
                                    <div class="invalid-feedback">
